...
const projectTools = [
  ...
  { name: "Jupyter", icon: Notebook, color: "cyan" },
    ...
    >
      ...
      <div className="max-w-6xl mx-auto bg-gray-900/60 backdrop-blur-md p-8 md:p-12 rounded-3xl border border-gray-800 shadow-2xl">
        ...
        <div className="grid md:grid-cols-2 gap-12">
          ...
          {/* Right Side - Stats, Skills, & TOOLS (NEW CONTENT) */}
          <div className="space-y-10"> 
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="p-4 bg-gray-800/40 rounded-xl border border-gray-700 text-center">
                <div className="text-2xl font-bold text-white flex justify-center items-center gap-2">
                  6+ <span className="text-blue-500 text-sm"><Sparkles className="w-4 h-4" /></span>
                </div>
                <p className="text-xs text-gray-400 mt-1">Fullstack Projects</p>
              </div>
            </div>
            ...
            {/* 2. NEW SECTION: Project Technology Stack */}
            <div className="space-y-5">
              <h3 className="text-xl font-bold mb-6 text-white flex items-center gap-2">
                <span className="p-2 bg-pink-500/20 rounded-lg text-pink-400"><Lightbulb className="w-5 h-5" /></span>
                ...
                {projectTools.map((tool, index) => (
                  <div 
                    ...
                    className={`flex items-center gap-2 px-4 py-2 text-sm font-medium rounded-full border 
                      ${tool.color === 'blue' ? 'bg-blue-700/30 border-blue-600/50 text-blue-300 hover:bg-blue-700/50' : ''}
                      ${tool.color === 'green' ? 'bg-green-700/30 border-green-600/50 text-green-300 hover:bg-green-700/50' : ''}
                      ${tool.color === 'purple' ? 'bg-purple-700/30 border-purple-600/50 text-purple-300 hover:bg-purple-700/50' : ''}
                      ${tool.color === 'cyan' ? 'bg-cyan-700/30 border-cyan-600/50 text-cyan-300 hover:bg-cyan-700/50' : ''}
                      ${tool.color === 'yellow' ? 'bg-yellow-700/30 border-yellow-600/50 text-yellow-300 hover:bg-yellow-700/50' : ''}
                      ${tool.color === 'pink' ? 'bg-pink-700/30 border-pink-600/50 text-pink-300 hover:bg-pink-700/50' : ''}
                      ${tool.color === 'orange' ? 'bg-orange-700/30 border-orange-600/50 text-orange-300 hover:bg-orange-700/50' : ''}
