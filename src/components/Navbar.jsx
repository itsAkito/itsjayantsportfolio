...
//             <p onClick={() => SetMenu("home")}>Home</p>{menu==="home"?<img src={nav_underline} alt=""/>:<></>}
//           </AnchorLink>
//         </li>
//         <li>
//           <AnchorLink className="anchor-link" offset={50} href="#about me">
//             <p onClick={() => SetMenu("about")}>About Me</p>{menu==="about"?<img src={nav_underline} alt=""/>:<></>}
//           </AnchorLink>
          
//         </li>
//         <li>
//           <AnchorLink className="anchor-link" offset={50} href="#portfolio">
//             <p onClick={() => SetMenu("portfolio")}>Portfolio</p>{menu==="portfolio"?<img src={nav_underline} alt=""/>:<></>}
//           </AnchorLink>
//         </li>
//         <li>
//           <AnchorLink className="anchor-link" offset={50} href="#contact">
//             <p onClick={() => SetMenu("contact")}>Contact</p>{menu==="contact"?<img src={nav_underline} alt=""/>:<></>}
//           </AnchorLink>
//         </li>
//       </ul>
